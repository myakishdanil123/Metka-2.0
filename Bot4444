...
# A letter attached directly to the house number is preserved: 25Ð/11 -> 25Ð.
ADDRESS_RE = re.compile(
    ...
    r"\s*[,â#]?\s*(?P<house>\d{1,4}[Ð-Ð¯Ð°-ÑÐÑÐÑÐÑÐÑÒÒA-Za-z]{0,3})"
    r"(?:\s*(?:[/.-])\s*\d{1,6}[Ð-Ð¯Ð°-ÑÐÑÐÑÐÑÐÑÒÒA-Za-z]{0,3})?"
    r"(?:\s*,?\s*(?:ÐºÐ²(?:Ð°ÑÑÐ¸ÑÐ°)?\.?|apt\.?|apartment)\s*â?\s*\d{1,6})?"
    r"\s*$"
)
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        ...
        "ÐÐ¾Ð¶Ð½Ð¾ Ð¿Ð¸ÑÐ°ÑÑ ÐºÐ²Ð°ÑÑÐ¸ÑÑ ÑÐµÑÐµÐ· / . Ð¸Ð»Ð¸ -: ÐÐµÑÐ¼Ð¾Ð½ÑÐ¾Ð²Ð° 25/11 â Ð¸ÑÑ Ð´Ð¾Ð¼ 25.\n"
